...
DROP TABLE IF EXISTS `TRANFER_LOGS`;
DROP TABLE IF EXISTS `OTHER_TEMP_CUSTOMER`;
...
CREATE TABLE IF NOT EXISTS `EPIS`.`DEDUCTION_MANUAL` (
	...
	UPDATEDTTM TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	VERSIONSTAMP BIGINT,
...
CREATE TABLE IF NOT EXISTS `EPIS`.`RECEIPT_MANUAL` (
	...
	PAID_DATE TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	...
	CANCEL_DATE TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	CANCEL_BY VARCHAR(20),
	CLEARING_BY VARCHAR(20),
	CLEARING_DATE TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
...
CREATE TABLE IF NOT EXISTS `EPIS`.`PAYMENT_INVOICE_MANUAL` (
  ...
  INCOMEUNIT varchar(15),
  DEPARTMENT_AREA varchar(100),
...
CREATE TABLE IF NOT EXISTS `EPIS`.`TRSCHEQUEREF_MANUAL` (
	...
	UPDATEDTTM TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	VERSIONSTAMP BIGINT,
	CHEQUEDATE TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	BOUNCE_CHEQUE_DATE TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	REVERSE_AR_DATE TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
...
CREATE TABLE IF NOT EXISTS `EPIS`.`MAP_GL_SERVICE_TYPE` (
	...
	UPDATE_DATE TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	RECORD_STATUS VARCHAR(20),
	ERP_INTERFACE_FLAG VARCHAR(1),
	PRIMARY KEY (`ID`)
)DEFAULT CHARSET=utf8;

CREATE TABLE `TRANFER_LOGS` (
	`ID` INT(11) NOT NULL AUTO_INCREMENT,
	`STARTDATE` TIMESTAMP NULL DEFAULT NULL,
	`ENDDATE` TIMESTAMP NULL DEFAULT NULL,
	`SUCCESSTASK` INT(11) NULL DEFAULT '0',
	`ERRORTASK` INT(11) NULL DEFAULT '0',
	`ERRORRECRIPT` VARCHAR(255) NULL DEFAULT '0',	
	`SYSTEM` VARCHAR(50) NULL DEFAULT '0',
	PRIMARY KEY (`ID`)
)
DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `EPIS`.`OTHER_TEMP_CUSTOMER` (
	CASUAL_ID BIGINT NOT NULL AUTO_INCREMENT,
	NAME VARCHAR(300),
	TAX_ID VARCHAR(20),
